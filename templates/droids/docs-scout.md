...
```
FetchUrl: https://nextjs.org/docs/app/api-reference/functions/cookies
...
| Error | Cause | Fix |
|-------|-------|-----|
| Docs not found | Framework/library unknown | Check package.json for exact package names |
| Version mismatch | Docs for wrong version | Check package.json for version, find versioned docs |
| Fetch failed | URL changed or blocked | Try official docs site directly, search for new URL |
