...
| Error | Cause | Fix |
|-------|-------|-----|
| Insufficient context | Research findings incomplete | Request more context from repo-scout/practice-scout |
| Ambiguous requirements | Spec too vague | List specific questions that need answers |
| No existing patterns | Greenfield feature | Note this explicitly, suggest looking at similar projects |
