...
| Error | Cause | Fix |
|-------|-------|-----|
| No changes found | Wrong branch or clean tree | Check `git status`, ensure changes are staged |
| Git diff failed | Not a git repo | Verify you're in a git repository |
| Test command failed | Tests not configured | Check AGENTS.md for correct test command |
