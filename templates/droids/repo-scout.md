...
| Error | Cause | Fix |
|-------|-------|-----|
| No matches found | Wrong search pattern | Try broader patterns, check file extensions |
| Permission denied | File access issue | Check file permissions, may need sudo |
| Too many results | Pattern too broad | Add file type filter or more specific pattern |
